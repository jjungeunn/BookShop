...
<script type="text/javascript">
	function add_cart(goods_id) {
		...
		var order_goods_qty = target.value;
		$.ajax({
			type : "post",
...
function fn_order_each_goods(goods_id,goods_title,goods_sales_price,fileName){
	...
	document.title = "${goods.goods_title }";
</script>
</head>
<body>
	<hgroup>
		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					...
					<td class="active"><span >
					<fmt:formatNumber  value="${goods.goods_sales_price}" type="number" var="goods_sales_price" />
					 <fmt:formatNumber  value="${100-(goods.goods_sales_price/goods.goods_price*100)}" type="number" var="salesP" />
				            ${goods_sales_price}원(${salesP}%할인)</span></td>
				</tr>
				<tr>
