			...
			<tr style="background:#33ff00" >
			 ...
			 <tr>       
               <form name="frm_order_all_cart">
					...
					<td>
					   <strong>
					      <fmt:formatNumber  value="${100-(item.goods_sales_price/item.goods_price*100)}" type="number" var="salesP" />
				            ${item.goods_sales_price}원(${salesP}%할인)
				         </strong>
					</td>
					<td>
				...
				<c:set  var="originalPrice" value="${originalPrice+item.goods_price*cart_goods_qty }"/>
	...
	<tbody>
		...
		<tr cellpadding=40  align=center >
	       ...
	       <td>
	          ...
	          <fmt:formatNumber  value="${originalPrice}" type="number" var="total_goods_price" />
				         ${total_goods_price}원
	          </p>
